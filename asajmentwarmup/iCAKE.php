...
<section class="w3-content">
                    ...
                    <div  class="w3-row w3-center">
                        <div class="w3-center"><h4>CAKE</h4></div><br>
                       
                        <?php
     require_once './functions.php';
     $query = "SELECT iId, iName, iDescription, iPrice, iStatus, iSize, iImage,cName FROM Item,Catalogue WHERE Item.catalogueId=Catalogue.cId AND cName LIKE '%CAKE%' ORDER BY cName";
