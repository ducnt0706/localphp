...
<section class="w3-content">
                    ...
                    <div  class="w3-row w3-center">
                        <div class="w3-center"><h4>SEARCH</h4></div><br>
                       
                        <?php
     require_once './functions.php';
     if(isset($_POST['keyword'])){
    $keyword = sanitizeString($_POST['keyword']);
    $query = "SELECT iId, iName, iDescription, iPrice, iStatus, iSize, iImage FROM Item WHERE iId LIKE '%WARMD%' AND (iName LIKE '%$keyword%' OR iId LIKE '%$keyword%')";
